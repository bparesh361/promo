...
<#include "../common/scripts.ftl">
     ...
     jQuery(document).ready(function(){
     			...
     			$("#profileSelect").change(function(){
                    var profile=$("#profileSelect option:selected").val();                   
                    if(profile !=-1){
                        $.ajax({
                            url: "getProfileModule.do?profileId="+profile,
                            cache:false,
                            global: false,
                            type: "POST",
                            dataType:"json",
				...
				$.getJSON("showProfiles.do", function(data){
    ...
    <body >
		<#include "../common/menu.ftl">
		 ...
		 <table width="100%" align="center">
            ...
            <tr>
                <td align="center">
                    <form action="updateModuleProfile.do" id="form" method="POST" >
                                ...
                                <td align="center">
                                    <table align="center" width="40%">
                                        <tr>
                                            ...
                                            <td align="left">
                                                <select name="profileSelect" id="profileSelect"  list="profileMap" headerKey="-1" headerValue="---Select Profile---" value="---Select Profile---" cssClass="dropdown"></select>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
