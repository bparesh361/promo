...
public class ControllerLogAspect {
	...
	/*@Around("execution(* com.fks.pwm.controller..*.*(..))")
	public void log(ProceedingJoinPoint joinPoint) throws Throwable {		
		long start = System.currentTimeMillis();
		logger.info(" # CLASS : " + joinPoint.getTarget().getClass()+ " # Method : " + joinPoint.getSignature().getName()+ "() # Arguments : " + Arrays.toString(joinPoint.getArgs()));
		joinPoint.proceed();
		long end = System.currentTimeMillis();
		logger.info(" # CLASS : " + joinPoint.getTarget().getClass()+ " # Method : " + joinPoint.getSignature().getName()+ "() # Arguments : " + Arrays.toString(joinPoint.getArgs()) + " Time Taken : " + (end-start));		
	}*/
